...
excerpt: >
  Try our projects. Make your own contributions.
nav_order: 100
has_children: false
---
...
Each [Hub project]({{site.baseurl}}/) has information about getting involved, such as posting issues and pull requests.
...
Every page on this website has an _Edit this page on GitHub_ link to the corresponding location for the page in the GitHub repo, making it easy to view a page's source, make edits, and submit a pull request. This is the easiest way to fix typos, for example.
