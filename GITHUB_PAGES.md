...
The [published website](https://the-ai-alliance.github.io/open-agent-hub/).
...
```markdown
[AI Alliance website](https://www.thealliance.ai/){:target="_blank"}
```

```html
<a href="https://www.thealliance.ai" target="_blank">AI Alliance website</a>
```
...
Furthermore, as a visual clue to the user, [our stylesheet](https://github.com/The-AI-Alliance/open-agent-hub/blob/main/docs/_sass/custom.scss) is configured to put little up-and-to-the-right arrows after every external link. This provides a visual cue that a new tab will be opened.
...
* The `--baseurl` flag effectively supports the simple URL, `localhost:$JEKYLL_PORT`. (Without it, the URL would be `localhost:$JEKYLL_PORT/The-AI-Alliance/open-agent-hub/`.)
...
Finally, if you are still stuck, please [post an issue](https://github.com/The-AI-Alliance/open-agent-hub/issues) to get help.
